...
const checkEndGame = () => {
    const disableCards = document.querySelectorAll('.desable-card')
...
const loadGame = () => {
    ...
    const duplicatesCharcters = [...characters, ...characters]

    const shufflefArray = duplicatesCharcters.sort(()=> Math.random() - 0.5)
    Math.random()

    duplicatesCharcters.forEach((characters) =>{
